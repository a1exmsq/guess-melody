...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      {profile ? (
        <div className="mb-8 flex items-center gap-4 bg-brand-panel/80 backdrop-blur-sm rounded-full px-6 py-3">
          {profile.images ? (
            <img src={profile.images} alt="avatar" className="w-10 h-10 rounded-full" />
          ) : (
            <div className="w-10 h-10 rounded-full bg-brand-primary flex items-center justify-center font-semibold text-brand-text font-bold">
        ...
        <button
          ...
          className="mb-8 bg-brand-primary hover:bg-brand-secondary font-semibold text-brand-text font-bold py-3 px-8 rounded-full flex items-center gap-3 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl w-full">
        <button
          ...
          className="group relative bg-brand-panel/80 backdrop-blur-sm hover:bg-brand-surface/80 rounded-2xl p-8 transition-all duration-300 hover:scale-105"
        >
