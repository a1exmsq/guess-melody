...
export default function TrackReveal({ track }: Props) {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-gray-900 border border-gray-700 rounded-3xl p-8 max-w-sm w-full mx-4 shadow-2xl shadow-brand-primary/10 transform scale-100 animate-in zoom-in-95 duration-300">
        {/* Album cover */}
